...
export default function About() {
    ...
    const renderImg = () => {
        return arrImg.map((item, index) => {
            return (
                <div>
                    <img className='rounded-[18px]' src={item} alt="logo" />
                </div>
            )
        })
    }
